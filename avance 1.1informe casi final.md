...
***El editor de código*** Se utilizó Visual Studio Code para implementar el proyecto Virtual Xp, con el cual era posible poder revisar nuestros códigos html, realizar cambios y correcciones, trabajar con código JS y CSS, para lo que refiere a la estética de la página.
...
Se recurrió a pruebas mediante Owas ZAP, con la cual se comprobó la existencia inicial de diversos puntos vlnerables a ataques en la página, los cuales fueron referenciados con puntos rojos. Por otra parte, con NMAP, se determinó, que existian ataques de DoS y Diffie Hellman Key.
